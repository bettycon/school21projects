...
class MapRenderer:
    ...
    def render_controls(self):
        ...
        self.controls_window.addstr(38, 18, "@donnapoc", curses.color_pair(23))
        self.controls_window.addstr(39, 10, "@dobberpe", curses.color_pair(23))
        self.controls_window.addstr(40, 2, "@yuccierh", curses.color_pair(23))
